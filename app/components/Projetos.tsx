...
const skills = [
		{
			...
			items: ['TypeScript', 'Python', 'Go', 'C', 'Java'],
			icon: (
...
return (
		<div className="py-6 bg-white dark:bg-neutral-900 px-6">
			<div className="space-y-4 max-w-2xl mx-auto">
				<div>
					<h3 className="text-lg font-semibold text-neutral-900 dark:text-white text-center md:text-left">Habilidades</h3>
					...
					{skills.map((skillGroup) => (
						<div key={skillGroup.category}>
							<div className="flex items-center space-x-2 mb-2">
								{skillGroup.icon}
								<h4 className="text-sm font-medium text-neutral-600 dark:text-neutral-400">{skillGroup.category}</h4>
							</div>
